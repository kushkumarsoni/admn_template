...
function PageVariation(){
	...
	$data = array();
	$results = SystemSetting::where('option_name', 'page_variation')->get();
...
function gtext(){
	...
	//general_settings
	$general_settings = SystemSetting::where('option_name', 'general_settings')->get();
	...
	//theme_logo
	$theme_logo = SystemSetting::where('option_name', 'theme_logo')->get();
	...
	//currency
 	$currency = SystemSetting::where('option_name', 'currency')->get();
	...
	//theme_option_header
 	$theme_option_header = SystemSetting::where('option_name', 'theme_option_header')->get();
	...
	//Language Switcher
	$language_switcher_data = SystemSetting::where('option_name', 'language_switcher')->get();
	...
	//theme_option_footer
 	$theme_option_footer = SystemSetting::where('option_name', 'theme_option_footer')->get();
	...
	//facebook
 	$facebook = SystemSetting::where('option_name', 'facebook')->get();
	...
	//twitter
 	$twitter = SystemSetting::where('option_name', 'twitter')->get();
	...
	//Theme Option SEO
 	$theme_option_seo = SystemSetting::where('option_name', 'theme_option_seo')->get();
	...
	//Theme Option Facebook Pixel
 	$theme_option_facebook_pixel = SystemSetting::where('option_name', 'facebook-pixel')->get();
	...
	//Theme Option Google Analytics
 	$theme_option_google_analytics = SystemSetting::where('option_name', 'google_analytics')->get();
	...
	//Theme Option Google Tag Manager
 	$theme_option_google_tag_manager = SystemSetting::where('option_name', 'google_tag_manager')->get();
	...
	//Google Recaptcha
 	$theme_option_google_recaptcha = SystemSetting::where('option_name', 'google_recaptcha')->get();
	...
	//Google Map
 	$theme_option_google_map = SystemSetting::where('option_name', 'google_map')->get();
	...
	//Theme Color
 	$theme_color = SystemSetting::where('option_name', 'theme_color')->get();
	...
	//Mail Settings
 	$theme_option_mail_settings = SystemSetting::where('option_name', 'mail_settings')->get();
	...
	//Stripe
	$stripe_data = SystemSetting::where('option_name', 'stripe')->get();
	...
	//Paypal
	$paypal_data = SystemSetting::where('option_name', 'paypal')->get();
	...
	//Razorpay
	$razorpay_data = SystemSetting::where('option_name', 'razorpay')->get();
	...
	//Mollie
	$mollie_data = SystemSetting::where('option_name', 'mollie')->get();
	...
	$cod_data = SystemSetting::where('option_name', 'cash_on_delivery')->get();
	...
	//Bank Transfer
	$bank_data = SystemSetting::where('option_name', 'bank_transfer')->get();
	...
	//MailChimp
	$mailchimp_data = SystemSetting::where('option_name', 'mailchimp')->get();
	...
	//Subscribe Popup
	$subscribe_popup_data = SystemSetting::where('option_name', 'subscribe_popup')->get();
	...
	//Whatsapp
	$whatsapp_data = SystemSetting::where('option_name', 'whatsapp')->get();
	...
	//custom_css
	$custom_css_data = SystemSetting::where('option_name', 'custom_css')->get();
	$custom_css = '';
	...
	//custom_js
	$custom_js_data = SystemSetting::where('option_name', 'custom_js')->get();
	$custom_js = '';
...
function vipc(){
	...
	$datalist = SystemSetting::where('option_name', 'vipc')->get();
...
function thumbnail($type){
	...
	$data = MediaSetting::where('media_type', $type)->first();
	$datalist = array(
...
function gSellerSettings(){
	...
	$datalist = SystemSetting::where('option_name', 'seller_settings')->get();
	$id = '';
	$option_value = '';
	foreach ($datalist as $row){
		$id = $row->id;
