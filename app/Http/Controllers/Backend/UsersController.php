...
class UsersController extends Controller
{
    ...
    public function getProfilePageLoad(){
        ...
        return view($this->theme.'.profile',compact('media_datalist'));
    }
    //Users page load
    public function getUsersPageLoad(){
        ...
        return view($this->theme.'.users', compact('statuslist', 'roleslist', 'media_datalist', 'datalist'));
    }
	...
	public function getUsersTableData(Request $request){
		...
		if($request->ajax()){
			...
			return view($this->theme.'.partials.users_table', compact('datalist'))->render();
		}
	}
